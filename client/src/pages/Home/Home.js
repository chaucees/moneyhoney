...
<div className="container-fluid">
    ...
    <div className="container section2">
        <div className="row">
            ...
            <div className="col l6 m6 s12" data-aos="fade-left" data-aos-duration="2000" align="center">
    ...
    <div className="container section4-home" data-aos="zoom-in" data-aos-duration="2000">
        <div className="row">
            <div className="col l4 m4 s12" align="center">
                ...
                <p>Never have a late payment again! Get alerts on upcoming bills, say goodbye to late feels, and see your income
                    and budget in one place.</p>
            </div>
            <div className="col l4 m4 s12" align="center">
                <i className="material-icons light-blue-text accent-2-text medium">face</i>
                <h2>Personzlied For You</h2>
                <p>Create new budgets today to set you up for success tomorrow. Receive alerts for unusual account charges and
                    get. Custom tips for reducing feeds and saving money.</p>
            </div>
            <div className="col l4 m4 s12" align="center">
                <i className="material-icons light-blue-text accent-2-text medium">wb_sunny</i>
                <h2>Free Credit Score</h2>
                <p>Find out yours for free and get tips to help improve it. Get your free credit score and learn how you can
                    improve it now to get the things you want later.</p>
            </div>
        </div>
    </div>
